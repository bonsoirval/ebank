  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard </h1><br/>Welcome! <br/>
             <?= ucfirst(auth()->user()->name); ?>
             <br/>Account Number : 3043449021
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>$<?php if($balance){echo $balance; }else{echo "0.00";} ?></h3>
                <p>Account Balance</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>$<?php if($last_withdrawal){echo $last_withdrawal;}else{echo "0.00";} ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>$<?php if ($last_deposit) {echo $last_deposit;}else{echo '0.00';}?></h3>
