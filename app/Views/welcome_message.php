      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0">ANZBN</a></h1>
          </div>
...
<!--                     <li class="has-children">
 ...
 -->                  <!-- </ul> -->
                ...
                <li><a href="<?= base_url('register'); ?>" class="nav-link">Create Account</a></li>
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-10 mt-lg-5 text-center">
            <div class="single-text owl-carousel">
              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Australian and New Zealand Banking Group</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Over the past 26 years, Australian and New Zealand Banking group has evolved from an obscure Australian Bank into a world-class financial institution. In terms of assets, loans, deposits and branch network; a feat which has been achieved through a robust long-term approach to client solutions – providing committed and innovative advice.</p>
              ...
              <div class="slide">
                ...
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Financing Solutions is a leading provider of lines of credit to nonprofits, small businesses, churches, and Fedex ISPs in the United States.</p>
              </div>

              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Savings Accounts</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Savings accounts, high-yield savings accounts, money market accounts, certificates of deposit, cash management accounts and specialty savings accounts.</p>
              </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="">
            ...
            <p>Save for a bright future today with our savings accounts. Take the first step towards managing your money better. Open a anzbn savings account today.</p>
          </div>
           <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>Shop with our cards (credit and debit) in all the local and international shopping.</p>
          </div>
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <p>Australian and New Zealand Debit Card guarantees 24/7 access to funds in your account, anywhere and anytime. It's safer than cash, a lot more convenient and easy to use.</p>
          </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Over the past 26 years, Australian and New Zealand Banking group has evolved from an obscure Australian Bank into a world-class financial institution. In terms of assets, loans, deposits and branch network; a feat which has been achieved through a robust long-term approach to client solutions – providing committed and innovative advice.

Australian and New Zealand Banking group
has built its strength and success in corporate banking and is now applying that expertise to the personal and business banking platforms it acquired from Australia  Commercial bank in 2012. The next two years were spent integrating the business, investing in infrastructure and strengthening the product offer.  

As part of its continued growth strategy, Australian and New Zealand Banking group is focused on mainstreaming sustainable business practices into its operations. The Bank strives to deliver sustainable economic growth that is profitable, environmentally responsible, and socially relevant.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
          ...
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>We are committed to providing you with seamless solutions to your financial needs.</p>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <span>GPO Box 3947. SYDNEY NSW 2002 · 8 Chifley Square SYDNEY NSW 2001</span>
            </p>
          </div>
           <div class="col-md-4 text-center">
            <p class="mb-4">
