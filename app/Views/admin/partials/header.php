...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url(); ?>dashboard/css/adminlte.min.css">
  <!-- overlayScrollbars -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url(); ?>dashboard/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('add_money'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Money</p>
                </a>
              </li>
          ...
          <!-- <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="< ?= base_url('withdrawals'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Withdrawal</p>
                </a>
              </li>
